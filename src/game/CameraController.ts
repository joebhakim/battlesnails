...
export class CameraController {
  declare lockOnEnabled: any;
  declare camera: any;
  declare distance: any;
  declare enemyFocusHeight: any;
  declare focus: any;
  declare focusBuffer: any;
  declare height: any;
  declare lookAheadDistance: any;
  declare lookAtBuffer: any;
  declare lookAtTarget: any;
  declare lookLerp: any;
  declare movementForward: any;
  declare playerFocusBias: any;
  declare playerFocusHeight: any;
  declare positionLerp: any;
  declare positionTarget: any;
  declare up: any;
  constructor(camera) {
    this.camera = camera;
