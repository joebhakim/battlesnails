...
function getCssRgb(color, alpha = null) {
...
export class DamageIndicators {
  constructor({ container, camera }) {
    ...
    this.activeGroupsByPair = new Map();
    this.activeBurstGroupsByPair = new Map();
    this.recentBurstByPair = new Map();
    this.nextGroupId = 1;
  ...
  handleSnapshotEvents(events = [], slotColors = new Map()) {
  ...
  addToWindow(event, bodyColor = null) {
