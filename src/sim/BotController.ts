...
export class BotController {
  ...
  declare attackCooldown: any;
  declare attackCooldownRemaining: any;
  declare attackPattern: any;
  declare attackRange: any;
  declare attackSide: any;
  declare backoffMoveScale: any;
  declare bothAttackChance: any;
  declare preferredDistance: any;
  declare random: any;
  declare recoverDuration: any;
  declare recoverMoveScale: any;
  declare state: any;
  declare stateTimer: any;
  declare strafeDirection: any;
  declare strafeMoveScale: any;
  declare strikeDuration: any;
  declare strikeMoveScale: any;
  declare windupDuration: any;
